...
zokuo({
  ...
  'categorie': "Search",
  'reaction': '🎥'
}, async (_0x3b8b7c, _0x17ec99, _0x3fdaba) => {
  const {
    ms: _0x414bd9,
    repondre: _0x3fc711,
    arg: _0x13cff7
  ...
  if (!_0x13cff7[0]) {
    _0x3fc711("Please insert a song/video name.");
    return;
  }
  try {
    let _0x5b529a = _0x13cff7.join(" ");
    let _0x4641ba = [];
    const _0x41903c = await yts(_0x5b529a);
    _0x4641ba = _0x41903c.videos;
    if (_0x4641ba && _0x4641ba.length > 0) {
      const _0x4552a6 = _0x4641ba[0].url;
      const _0x394b61 = await fetch("https://gifted-apis-third-30b2fdbb9819.herokuapp.com/api/download/ytmp4?url=" + encodeURIComponent(_0x4552a6) + "&apikey=" + "giftedtechk");
      const _0x4f322a = await _0x394b61.json();
      if (_0x4f322a.status === 200 && _0x4f322a.success) {
        const _0x5a4698 = _0x4f322a.result.download_url;
        const _0x37a71e = {
          'image': {
            'url': _0x4641ba[0].thumbnail
          },
          'caption':"*BMW VIDEO PLAYER*"
           
        };
        await _0x17ec99.sendMessage(_0x3b8b7c, _0x37a71e, {
          'quoted': _0x414bd9
        });
        await _0x17ec99.sendMessage(_0x3b8b7c, {
          'document': {
            'url': _0x5a4698
          },
          'mimetype': "video/mp4"
        ...
        _0x3fc711("Download Success...");
      } else {
        _0x3fc711("Failed to download the video. Please try again later.");
      }
    } else {
      _0x3fc711("No videos found.");
    }
  } catch (_0x8d57d7) {
    console.error("Error from API:", _0x8d57d7);
    _0x3fc711("An error occurred while searching or downloading the video.");
  }
});
**/
